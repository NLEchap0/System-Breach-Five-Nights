...
anim_attacco = [
	...
	"Tenta di hackerare la barriera energetica della sua cella tramite un terminale interno, se supera il 50% del progresso non sarà più possibile fermarlo. Una volta libero, casualmente nel tempo, si potrà manifestare nel tuo ufficio segnalando la sua presenza tramite segnali audio."
];
