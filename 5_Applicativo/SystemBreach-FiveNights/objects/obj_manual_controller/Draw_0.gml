...
if(!(page == 2)){
	...
	// --- DISEGNO DEL TITOLO: Attacco ---
	draw_set_font(global.fnt_sub_titolo); // Imposta il font
	draw_text(box_x, section_y + altezza_titolo + 20, "Attacco");

	// --- DISEGNO DEL TESTO: Attacco ---
	draw_set_font(global.fnt_normale); // Imposta il font
	draw_text_ext(box_x, section_y + 120, anim_attacco[page], -1, 600);

	// --- DISEGNO DEL TITOLO: Difesa ---
	draw_set_font(global.fnt_sub_titolo); // Imposta il font
	draw_text(box_x, section_y + 230, "Difesa");

	// --- DISEGNO DEL TESTO: Difesa ---
	draw_set_font(global.fnt_normale); // Imposta il font
	draw_text_ext(box_x, section_y + 290, anim_difesa[page], -1, 600);
	
	// --- DISEGNO DEL TITOLO: Diario ---
	draw_set_font(global.fnt_sub_titolo); // Imposta il font
	draw_text(box_x, section_y + 440, "Diario");
	/*
